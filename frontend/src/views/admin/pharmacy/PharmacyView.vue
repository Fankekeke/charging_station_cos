<template>
  <a-modal v-model="show" title="商家详情" @cancel="onClose" :width="800">
    ...
    <div style="font-size: 13px;font-family: SimHei" v-if="pharmacyData !== null">
      ...
      <br/>
      <a-row style="padding-left: 24px;padding-right: 24px;">
        <a-col style="margin-bottom: 15px"><span style="font-size: 15px;font-weight: 650;color: #000c17">商家图片</span></a-col>
        <a-col :span="24">
          <a-upload
            name="avatar"
      ...
      <br/>
      <a-row style="padding-left: 24px;padding-right: 24px;">
        <a-col style="margin-bottom: 5px"><span style="font-size: 15px;font-weight: 650;color: #000c17">商家位置</span></a-col>
      </a-row>
      <div>
